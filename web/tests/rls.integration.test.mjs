import { testAnalysisHistory } from "./helpers/analysis-history-integration.mjs";
...
if (!enabled) {
  ...
  test("RLS: 施設間隔離・Storage・無効アカウントを拒否する", async (t) => {
    ...
    try {
      ...
      await testAnalysisHistory(t, {
        adminApi, admin, staffA, staffB, anonymous: createClient(url, publishableKey),
